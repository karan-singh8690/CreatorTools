...
export type ViewType = 'home' | 'all-tools' | 'pdf-viewer' | 'combine-files' | 'batch-print' | 'convert' | 'ocr' | 'compress' | 'qr-generator' | 'extract-text' | 'watermark' | 'security' | 'header-footer' | 'bates-number' | 'background' | 'crop' | 'sign' | 'cleanup' | 'terabox-player' | 'settings'
